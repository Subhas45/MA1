class room2 extends Phaser.Scene {
  ...
  init(data) {
    ...
    this.load.spritesheet("exitone", "assets/exit.png", {frameWidth: 321,frameHeight: 321});
    this.load.spritesheet("pointone", "assets/point.png", {frameWidth: 321,frameHeight: 321}); 
    ...
    this.load.audio('room2','assets/lonely.mp3');
    ...
    create() {
       ...
       //sound
        ...
        // this.backgroundmusicroom2 = this.sound.add('room2').setVolume(0.3);
        this.collectsound = this.sound.add('collect').setVolume(0.5);

        //  window.music= this.backgroundmusicroom2
        //  window.music.play();
        ...
        // Tween  
         ...
         this.sheep8 = this.physics.add.sprite(478, 1184, "sheep7").play("sheepAnimation").setScale(0.2);
        ...
        this.physics.add.overlap(this.player, this.sheep8, this.overlapsen, null, this );
       ...
       this.time.addEvent({
        ...
        //direction
        this.exit1 = this.physics.add.sprite(173, 290, 'exitone').setScale(0.5);
       this.point2 = this.physics.add.sprite(618, 1411, 'pointone').setScale(0.2);
