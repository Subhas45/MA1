class room1 extends Phaser.Scene {
    ...
    create() {
        ...
        this.cow8 = this.physics.add.sprite(236, 1613, "cow8").play("cowAnimation").setScale(0.2);
       ...
       this.physics.add.overlap(this.player, this.cow8, this.overlapsen, null, this );
